...
const jzodBootstrapElementZodSchema:ZodTextAndZodSchema = jzodToZodTextAndZodSchema(jzodBootstrapElementSchema);

async function compareZodSchemas(
  testName: string,
  referenceZodSchema: ZodTypeAny,
  testJzodSchema: JzodElement,
  definitions?: ZodTextAndZodSchemaRecord
) {
  // TODO: comparison of JSON schemas does not take "strict" into account
  console.log("######################## starting", testName);

  const testJzodSchemaZodSchemaAndDescription: ZodTextAndZodSchema = jzodToZodTextAndZodSchema(
    testJzodSchema,
...
describe(
  ...
  () => {
    ...
    //   //   jzodToZodTextAndZodSchema(jzodBootstrapElementSchema);
    ...
    it('jzod simple data parsing',
      () => {
        const absoluteReferences = {
          "123": jzodToZodTextAndZodSchema({type: "string"})
        }
        ...
        const test0ZodSchema:ZodTextAndZodSchema = jzodToZodTextAndZodSchema(test0);
        const test1ZodSchema:ZodTextAndZodSchema = jzodToZodTextAndZodSchema(test1);
        const test2ZodSchema:ZodTextAndZodSchema = jzodToZodTextAndZodSchema(test2);
        const test3ZodSchema:ZodTextAndZodSchema = jzodToZodTextAndZodSchema(test3);
        const test4ZodSchema:ZodTextAndZodSchema = jzodToZodTextAndZodSchema(test4);
        const test5ZodSchema:ZodTextAndZodSchema = jzodToZodTextAndZodSchema(test5);
        const test6ZodSchema:ZodTextAndZodSchema = jzodToZodTextAndZodSchema(test6);
        const test7ZodSchema:ZodTextAndZodSchema = jzodToZodTextAndZodSchema(test7);
        const test8ZodSchema:ZodTextAndZodSchema = jzodToZodTextAndZodSchema(
          test8,
          undefined,
          () => absoluteReferences
        );
        const test9ZodSchema:ZodTextAndZodSchema = jzodToZodTextAndZodSchema(test9);
        const test10ZodSchema: ZodTextAndZodSchema = jzodToZodTextAndZodSchema(
          test10,
          undefined,
          () => absoluteReferences
        );
        const test11ZodSchema:ZodTextAndZodSchema = jzodToZodTextAndZodSchema(test11);
        const test12ZodSchema:ZodTextAndZodSchema = jzodToZodTextAndZodSchema(test12);
        const test13ZodSchema:ZodTextAndZodSchema = jzodToZodTextAndZodSchema(test13);
        const test14ZodSchema:ZodTextAndZodSchema = jzodToZodTextAndZodSchema(test14);
        const test15ZodSchema:ZodTextAndZodSchema = jzodToZodTextAndZodSchema(test15);
        const test16ZodSchema:ZodTextAndZodSchema = jzodToZodTextAndZodSchema(test16);
        const test17ZodSchema:ZodTextAndZodSchema = jzodToZodTextAndZodSchema(test17);
        const test18ZodSchema:ZodTextAndZodSchema = jzodToZodTextAndZodSchema(test18);
        const test19ZodSchema:ZodTextAndZodSchema = jzodToZodTextAndZodSchema(test19);
        const test20ZodSchema:ZodTextAndZodSchema = jzodToZodTextAndZodSchema(test20);
        const test21ZodSchema:ZodTextAndZodSchema = jzodToZodTextAndZodSchema(test21);
        const test22ZodSchema:ZodTextAndZodSchema = jzodToZodTextAndZodSchema(test22);
        const test23ZodSchema:ZodTextAndZodSchema = jzodToZodTextAndZodSchema(test23);
        const test24ZodSchema:ZodTextAndZodSchema = jzodToZodTextAndZodSchema(test24);
    ...
    it("Jzod to Zod and back",
      async() => {
        ...
        const lazyRef:ZodTextAndZodSchema = jzodToZodTextAndZodSchema(
          {type:"string"},
          () => ({}) as ZodTextAndZodSchemaRecord,
          () => ({}) as ZodTextAndZodSchemaRecord,
        );
        ...
        const testZodToJzodConversion = (
          ...
          const testZodSchemaAndDescription:ZodTextAndZodSchema = jzodToZodTextAndZodSchema(
            testJzodSchema,
            () => ({}) as ZodTextAndZodSchemaRecord,
            () => ({lazyRef}) as ZodTextAndZodSchemaRecord,
          )
